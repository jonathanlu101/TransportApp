...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3StopOnRoute :  IEquatable<V3StopOnRoute>
    {
        /// <summary>
        ...
        public V3StopOnRoute(string StopName = null, int? StopId = null, int? RouteType = null, float? StopLatitude = null, float? StopLongitude = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3StopOnRoute);
        }

        /// <summary>
        /// Returns true if V3StopOnRoute instances are equal
        /// </summary>
        /// <param name="other">Instance of V3StopOnRoute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopOnRoute other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
