...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3Status :  IEquatable<V3Status>
    {
        /// <summary>
        ...
        public V3Status(string Version = null, HealthEnum? Health = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3Status);
        }

        /// <summary>
        /// Returns true if V3Status instances are equal
        /// </summary>
        /// <param name="other">Instance of V3Status to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3Status other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
