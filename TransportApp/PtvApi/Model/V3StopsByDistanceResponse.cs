...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3StopsByDistanceResponse :  IEquatable<V3StopsByDistanceResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3StopsByDistanceResponse);
        }

        /// <summary>
        /// Returns true if V3StopsByDistanceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V3StopsByDistanceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopsByDistanceResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
