...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3DisruptionsResponse :  IEquatable<V3DisruptionsResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3DisruptionsResponse);
        }

        /// <summary>
        /// Returns true if V3DisruptionsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V3DisruptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DisruptionsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.Disruptions.Equals(other.Disruptions)
                ) && 
                (
