...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3StopsOnRouteResponse :  IEquatable<V3StopsOnRouteResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3StopsOnRouteResponse);
        }

        /// <summary>
        /// Returns true if V3StopsOnRouteResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V3StopsOnRouteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopsOnRouteResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
