...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3StopResponse :  IEquatable<V3StopResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3StopResponse);
        }

        /// <summary>
        /// Returns true if V3StopResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V3StopResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
