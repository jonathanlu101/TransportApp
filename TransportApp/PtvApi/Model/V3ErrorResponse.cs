...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3ErrorResponse :  IEquatable<V3ErrorResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3ErrorResponse);
        }

        /// <summary>
        /// Returns true if V3ErrorResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V3ErrorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3ErrorResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
