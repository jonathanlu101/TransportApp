...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3StopGeosearch :  IEquatable<V3StopGeosearch>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3StopGeosearch" /> class.
        /// </summary>
        ...
        public V3StopGeosearch(float? StopDistance = null, string StopName = null, int? StopId = null, int? RouteType = null, float? StopLatitude = null, float? StopLongitude = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3StopGeosearch);
        }

        /// <summary>
        /// Returns true if V3StopGeosearch instances are equal
        /// </summary>
        /// <param name="other">Instance of V3StopGeosearch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3StopGeosearch other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
