...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3Direction :  IEquatable<V3Direction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3Direction" /> class.
        /// </summary>
        ...
        public V3Direction(int? DirectionId = null, string DirectionName = null, int? RouteId = null, int? RouteType = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3Direction);
        }

        /// <summary>
        /// Returns true if V3Direction instances are equal
        /// </summary>
        /// <param name="other">Instance of V3Direction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3Direction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
