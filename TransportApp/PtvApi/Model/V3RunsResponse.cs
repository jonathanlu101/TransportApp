...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3RunsResponse :  IEquatable<V3RunsResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3RunsResponse);
        }

        /// <summary>
        /// Returns true if V3RunsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V3RunsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3RunsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
