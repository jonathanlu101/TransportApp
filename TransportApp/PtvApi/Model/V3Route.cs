...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3Route :  IEquatable<V3Route>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3Route" /> class.
        /// </summary>
        ...
        public V3Route(int? RouteType = null, int? RouteId = null, string RouteName = null, string RouteNumber = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3Route);
        }

        /// <summary>
        /// Returns true if V3Route instances are equal
        /// </summary>
        /// <param name="other">Instance of V3Route to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3Route other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
