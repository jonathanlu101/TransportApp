...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3DirectionsResponse :  IEquatable<V3DirectionsResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3DirectionsResponse);
        }

        /// <summary>
        /// Returns true if V3DirectionsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V3DirectionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DirectionsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
