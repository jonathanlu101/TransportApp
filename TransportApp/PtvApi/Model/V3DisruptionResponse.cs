...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3DisruptionResponse :  IEquatable<V3DisruptionResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3DisruptionResponse);
        }

        /// <summary>
        /// Returns true if V3DisruptionResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V3DisruptionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3DisruptionResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.Disruption == other.Disruption ||
                    this.Disruption != null &&
                    this.Disruption.Equals(other.Disruption)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Disruption != null)
                    hash = hash * 59 + this.Disruption.GetHashCode();
                if (this.Status != null)
