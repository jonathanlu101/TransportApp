...
namespace TransportApp.PTVApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3RouteResponse :  IEquatable<V3RouteResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V3RouteResponse);
        }

        /// <summary>
        /// Returns true if V3RouteResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of V3RouteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3RouteResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
