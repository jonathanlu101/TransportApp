...
namespace TransportApp.PTVApi.Api
{
    ...
    public interface ISearchApi : IApiAccessor
    {
        ...
        V3SearchResult SearchSearch (string searchTerm, List<int?> routeTypes = null, float? latitude = null, float? longitude = null, float? maxDistance = null, bool? includeAddresses = null, bool? includeOutlets = null, string token = null, string devid = null, string signature = null);
        ...
        ApiResponse<V3SearchResult> SearchSearchWithHttpInfo (string searchTerm, List<int?> routeTypes = null, float? latitude = null, float? longitude = null, float? maxDistance = null, bool? includeAddresses = null, bool? includeOutlets = null, string token = null, string devid = null, string signature = null);
        ...
        System.Threading.Tasks.Task<V3SearchResult> SearchSearchAsync (string searchTerm, List<int?> routeTypes = null, float? latitude = null, float? longitude = null, float? maxDistance = null, bool? includeAddresses = null, bool? includeOutlets = null, string token = null, string devid = null, string signature = null);
    ...
    public partial class SearchApi : ISearchApi
    {
        ...
        /// <param name="signature">Authentication signature for request (optional)</param>
        /// <returns>V3SearchResult</returns>
        public V3SearchResult SearchSearch (string searchTerm, List<int?> routeTypes = null, float? latitude = null, float? longitude = null, float? maxDistance = null, bool? includeAddresses = null, bool? includeOutlets = null, string token = null, string devid = null, string signature = null)
        {
             ApiResponse<V3SearchResult> localVarResponse = SearchSearchWithHttpInfo(searchTerm, routeTypes, latitude, longitude, maxDistance, includeAddresses, includeOutlets, token, devid, signature);
        ...
        /// <param name="signature">Authentication signature for request (optional)</param>
        /// <returns>ApiResponse of V3SearchResult</returns>
        public ApiResponse< V3SearchResult > SearchSearchWithHttpInfo (string searchTerm, List<int?> routeTypes = null, float? latitude = null, float? longitude = null, float? maxDistance = null, bool? includeAddresses = null, bool? includeOutlets = null, string token = null, string devid = null, string signature = null)
        {
            ...
            if (searchTerm != null) localVarPathParams.Add("search_term", Configuration.ApiClient.ParameterToString(searchTerm)); // path parameter
            ...
            if (includeAddresses != null) localVarQueryParams.Add("include_addresses", Configuration.ApiClient.ParameterToString(includeAddresses)); // query parameter
            if (includeOutlets != null) localVarQueryParams.Add("include_outlets", Configuration.ApiClient.ParameterToString(includeOutlets)); // query parameter
            ...
            return new ApiResponse<V3SearchResult>(localVarStatusCode,
                ...
                (V3SearchResult) Configuration.ApiClient.Deserialize(localVarResponse, typeof(V3SearchResult)));
        ...
        /// <param name="signature">Authentication signature for request (optional)</param>
        /// <returns>Task of V3SearchResult</returns>
        public async System.Threading.Tasks.Task<V3SearchResult> SearchSearchAsync (string searchTerm, List<int?> routeTypes = null, float? latitude = null, float? longitude = null, float? maxDistance = null, bool? includeAddresses = null, bool? includeOutlets = null, string token = null, string devid = null, string signature = null)
        {
             ApiResponse<V3SearchResult> localVarResponse = await SearchSearchAsyncWithHttpInfo(searchTerm, routeTypes, latitude, longitude, maxDistance, includeAddresses, includeOutlets, token, devid, signature);
             return localVarResponse.Data;
